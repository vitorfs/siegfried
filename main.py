...
class DjangoApplication(object):
    ...
    def cfg_favicon(self, root):
        ...
        cherrypy.tree.mount(None, '/img/favicon.ico', {'/': config})
...
if __name__ == '__main__':
    ...
    if run_as_binary is True:
        log_file = os.path.join(base_dir, "..", "logs/siegfried.log")
    ...
    log = logging.getLogger("Siegfried")
    ...
    # Django settings
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'siegfried.settings')
    ...
    webview.create_window("Siegfried", "http://localhost:9090",
